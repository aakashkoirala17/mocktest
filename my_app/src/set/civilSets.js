export const civilQuizData = [
  ...
  {
    question:
      "A square matrix [a] is neither symmetric nor skew-symmetric, and [a]T is its transpose. The sum and difference of these matrices are defined as [s] = [a] + [a]T and [d] = [a] - [a]T, respectively. Which of the following statements is true?",
    answer: "4) [s] is symmetric and [d] is skew-symmetric",
    section: "A",
    mark: 1,
    options: [
  ...
  {
    question:
      "The square root of the number N is to be obtained by applying the Newton Raphson's iterations to the equation x² – N = 0. If i denotes the iteration index, the correct iterative scheme will be",
    answer: "1) xᵢ₊₁ = 1 / (xᵢ + N)",
    section: "A",
    mark: 1,
    options: [
  ...
  },
  {
    ...
    section: "A",
    mark: 1,
    options: ["1) 1/7", "2) 9/49", "3) 12/49", "4) 3/7"],
  },
  {
    question:
    ...
    section: "A",
    mark: 1,
    options: ["1) 0.61s", "2) 0.65s", "3) 0.70s", "4) 0.75s"],
  },

  {
    ...
    options: [
      ...
      "3) Corrosion causes circumferential tensile stresses in concrete and the cracks will be perpendicular to the direction of the corroded reinforcing bar.",
      "4) Corrosion causes radial tensile stresses in concrete and the cracks will perpendicular to the direction of the corroded reinforcing bar.",
    ],
  },
  {
    question:
      "The cross-section of a thermo-mechanically treated (TMT) reinforcing bar has",
    answer: "3) a soft ferrite-pearlite core with a hard martensitic rim.",
    section: "A",
    mark: 1,
    options: [
  ...
  },
  {
    ...
    section: "A",
    mark: 1,
    options: ["1) 0.54", "2) 0.98", "3) 1.02", "4) 1.87"],
  },
  {
    question:
      "Likelihood of general shear failure for an isolated footing in sand decreases with",
    answer: "2) Decreasing inter-granular packing of the sand",
    section: "A",
    mark: 1,
    options: [
      "1) Decreasing footing depth",
      "2) Decreasing inter-granular packing of the sand",
  ...
  {
    question:
      "For a sample of dry, cohesionless soil with a friction angle, 𝜙, the failure plane will be inclined to the major principal plane by an angle equal to",
    answer: "4) 45° + 𝜙/2",
    section: "A",
    mark: 1,
    options: ["1) 𝜙", "2) 45°", "3) 45° - 𝜙/2", "4) 45° + 𝜙/2"],
  },
  {
    question:
      "A soil is compressed of solid spherical grains of identical specific gravity and diameter between 0.075 mm and 0.0075 mm. If the terminal velocity of the largest particle falling through water without flocculation is 0.5 mm/s, that for the smallest particle would be",
    answer: "1) 0.005 mm/s",
    section: "A",
    mark: 1,
    options: ["1) 0.005 mm/s", "2) 0.05 mm/s", "3) 5 mm/s", "4) 50 mm/s"],
  },
  {
    question:
    ...
    answer: "3) Decrease the time base",
    section: "A",
    mark: 1,
    options: [
      "1) Decrease the volume of runoff",
...

  {
    ...
    mark: "1",
    question:
      "Anaerobically treated effluent has MPN of total coliform as 10^6/100mL. After chlorination, the MPN value declines to 10^2/100mL. The percent removal (%R) and log removal (log R) of total coliform MPN is",
    options: [
      "%R = 99.99; log R = 4",
      "%R = 99.90; log R = 2",
      "%R = 99.99; log R = 4",
  ...
  },
  {
    ...
    options: ["λe^(λt1)", "λe^(-t1)", "e^(λt1)", "e^(-λt1)"],
    answer: "e^(-λt1)",
  },
  {
    section: "a",
    ...
    options: ["R^3 / (vJ)", "J^3 / (Rv)", "v^2R / J", "v^3 / (RJ)"],
    answer: "v^3 / (RJ)",
  },
  ...
  },
  {
    ...
    section: "A",
    mark: 1,
    options: ["1) O3", "2) NO", "3) SO2", "4) Soot"],
  },
  {
    question:
      "The probability that k number of vehicles arrive (i.e, cross a predefined line) in time t is given as λt^k e^(-λt) / k!, where λ is the average vehicle arrival rate. What is the probability that the time headway is greater than or equal to time t1?",
    ...
    section: "A",
    mark: 1,
    options: ["1) λe^(λt1)", "2) λe^(-t1)", "3) e^(λt1)", "4) e^(-λt1)"],
  },
  {
    question:
      "A vehicle negotiates a transition curve with uniform speed v. If the radius of the horizontal curve and the allowable jerk are R and J, respectively, the minimum length of the transition curve is",
    ...
    section: "A",
    mark: 1,
    options: ["1) R^3 / (vJ)", "2) J^3 / (Rv)", "3) v^2R / J", "4) v^3 / (RJ)"],
  },

  {
    question:
      "Choose the most appropriate word from the options given below to complete the following sentence The official answered _________ that the complaints of the citizen would be looked into.",
    answer: "2) respectfully",
    section: "A",
    mark: 1,
    options: [
      "1) respectably",
  ...
  {
    question: "Choose the statement where underlined word is used correctly",
    answer: "2) He ensured that the company will not have to bear any loss.",
    section: "A",
    mark: 1,
    options: [
      "1) The minister insured the victims that everything would be all right.",
      "2) He ensured that the company will not have to bear any loss.",
      "3) The actor got himself ensured against any accident.",
      "4) The teacher insured students of good results",
    ],
  },
  {
    question:
  ...
  {
    question: "Which word is not a synonym for the word vernacular?",
    answer: "3) indigent",
    section: "A",
    mark: 1,
    options: ["1) regional", "2) indigenous", "3) indigent", "4) colloquial"],
  },
  {
    question:
  ...
  {
    question:
      "Given cos x isin x i 1, the value of the definite integral, I dx is : cos x isin x",
    answer: "3) i",
    section: "A",
    mark: 1,
    options: ["1) 1", "2) –1", "3) i", "4) –i"],
  },
  {
    question: "SO2 and CO adversely affect",
    answer:
      "3) functioning of the respiratory system and oxygen carrying capacity of blood respectively",
    section: "A",
    mark: 1,
    options: [
      "1) oxygen carrying capacity of blood and functioning of lungs respectively",
      "2) functioning of the respiratory system and brain respectively",
      "3) functioning of the respiratory system and oxygen carrying capacity of blood respectively",
      "4) functioning of air passages and chest respectively.",
    ],
  },

  {
    question:
      "Let $A_{ij} = i.j$ for $1 \\leq i, j \\leq n$ with $n \\geq 3$. The rank of A is __________.",
    answer: "(B) 1",
    section: "A",
    mark: 1,
  ...
  {
    question:
      "A hydraulic jump takes place in a frictionless rectangular channel. The pre-jump depth is $y_p$. The alternate and sequent depths corresponding to $y_p$ are $y_a$ and $y_s$ respectively. The correct relationship among $y_p$",
    answer: "(B) $y_p < y_s < y_a$",
    section: "A",
    mark: 1,
    options: [
      "(A) $y_a < y_s < y_p$",
...

  {
    ...
    section: "A",
    mark: 1,
    options: ["(A) 1.761", "(B) 0.176", "(C) 0.253", "(D) 2.530"],
  },
  ...
  {
    question: "A hot short metal is",
    answer: "b) brittle when hot",
    section: "A",
    mark: 1,
    options: [
      "a) brittle when cold",
  ...
  {
    question: "Resilience of a material is important, when it is subjected to",
    answer: "e) shock loading",
    section: "A",
    mark: 1,
    options: [
      "a) combined loading",
  ...
  },
  {
    ...
    answer: "a) decreasing  the cross-section area of’ bar",
    section: "A",
    mark: 1,
    options: [
  ...
  {
    question: "Other method of reducing shock load in the above case can be",
    answer: "b) to increase length",
    section: "A",
    mark: 1,
    options: [
  ...
  },
  {
    ...
    answer: "a) be independent of ratio of mass of load W to mass of bar (y)",
    section: "A",
    mark: 1,
    options: [
  ...
  {
    question: "Brittle coating technique is used for",
    answer: "d) experimental stress analysis",
    section: "A",
    mark: 1,
    options: [
  ...
  {
    question: "Stress concentration is caused due to",
  ...
  {
    question: "Plastic flow in ductile materials",
    answer:
